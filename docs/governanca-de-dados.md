...
| **Autoria** | Preservada nas três ramificações (`main`: 103 commits na reescrita; `79-impconfreg22nov23`: 44; `CON-25-SIAFI-WEB`: 85). Os commits de documentação posteriores à reescrita elevam a contagem corrente de `main`, sem alterar o resultado acima |
